...
router
    .route('/get-all')
    .get(auth_middleware_1.isAuthenticated, auth_middleware_1.isAdmin, poolController.getAllPools);
router.route('/get-my-pool').get(auth_middleware_1.isAuthenticated, poolController.myPool);
router
    .route('/:id')
