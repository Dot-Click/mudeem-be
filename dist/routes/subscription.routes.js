...
const revenuecat_controller_1 = require("../controllers/subscription/revenuecat.controller");
const subscription_schema_1 = require("../validations/subscription.schema");
const router = express_1.default.Router();
// Protected routes (require authentication)
router.post('/purchase', auth_middleware_1.isAuthenticated, (0, validate_middleware_1.validate)(subscription_schema_1.verifySubscriptionSchema, 'body'), subscription_controller_1.verifySubscription);
router.post('/verify', auth_middleware_1.isAuthenticated, (0, validate_middleware_1.validate)(subscription_schema_1.verifySubscriptionSchema, 'body'), subscription_controller_1.verifySubscription);
router.get('/my-subscriptions', auth_middleware_1.isAuthenticated, subscription_controller_1.getUserSubscriptions);
router.get('/status', auth_middleware_1.isAuthenticated, (0, validate_middleware_1.validate)(subscription_schema_1.subscriptionStatusSchema, 'query'), subscription_controller_1.checkSubscriptionStatus);
router.get('/history', auth_middleware_1.isAuthenticated, subscription_controller_1.getSubscriptionHistory);
router.post('/cancel/:subscriptionId', auth_middleware_1.isAuthenticated, (0, validate_middleware_1.validate)(subscription_schema_1.cancelSubscriptionSchema, 'params'), subscription_controller_1.cancelSubscription);
