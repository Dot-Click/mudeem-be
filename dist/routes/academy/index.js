...
router
    .route('/book/:id')
    .get(auth_middleware_1.isAuthenticated, academyController.getBook)
    .patch(auth_middleware_1.isAuthenticated, 
// validate(schema.updateAcademy),
multer_middleware_1.default.fields([
    { name: 'cover', maxCount: 1 },
    { name: 'file', maxCount: 1 }
]), academyController.updateBook)
    .delete(auth_middleware_1.isAuthenticated, academyController.deleteBook);
router
